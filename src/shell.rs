...
//     //                     }
//     //                     Key::ArrowUp => {
//     //                         if self.screen.lines().rev().take(self.rows_scrolled_up +
// BUFFER_HEIGHT + 1).count() > self.rows_scrolled_up + vga::BUFFER_HEIGHT {     //
...
// const PROMPT_SIZE: usize = (terminal::screen::BUFFER_SIZE *
// PROMPT_SIZE_PERCENTAGE_OF_SCREEN_SIZE) / 100;
//
// #[derive(Debug)]
// pub struct Prompt {
