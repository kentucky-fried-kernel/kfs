...
// use crate::{port::Port, ps2::DATA_PORT};
//
// #[repr(u8)]
// #[derive(PartialEq)]
// pub enum Command {
...
//     if !validate_checksum(fadt_ptr as *const u8, unsafe { (*((fadt as *const
// Fadt).cast::<SDTHeader>())).length }) {         return Err("FADT checksum verification failed");
//     }
//
