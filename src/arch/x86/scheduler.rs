...
use crate::{
    ...
    binaries::{memory_protection::memory_protection_test, signals::signal_print_test, sockets::sockets_test, wait::wait_test},
    serial_println,
    signals::Action,
};
...
pub fn init() {
    let p = Process::new(&memory_protection_test(), super::vmm::process::Parent::Root, false);
