...
use crate::{
    ...
    binaries::{
        fork_bomb::fork_bomb_test, memory_protection::memory_protection_test, signals::signal_print_test, sockets::sockets_test, super_user::super_user_test,
        wait::wait_test,
    },
    serial_println,
    signals::Action,
...
pub fn init() {
    let b = super_user_test();
    let p = Process::new(&b, super::vmm::process::Parent::Root, false);
