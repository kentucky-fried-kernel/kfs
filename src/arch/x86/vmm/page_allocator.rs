...
impl Node {
    ...
    fn encode(val: Option<usize>) -> Option<u64> {
        match val {
    ...
    fn decode(bits: u64) -> Option<usize> {
...
impl<'a> PageAllocator<'a> {
    ...
    pub fn split(&mut self, order: usize) {
    ...
    pub fn split_node(&mut self, index_node: usize, index_order: usize) {
    ...
    pub fn node_add(&mut self, index_node: usize, index_order: usize) {
    ...
    pub fn node_remove(&mut self, index_node: usize, index_order: usize) {
