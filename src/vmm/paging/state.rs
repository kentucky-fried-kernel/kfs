...
pub static mut KERNEL_PAGE_DIRECTORY_TABLE: PageDirectory = {
    ...
    dir[1] = PageDirectoryEntry::from_usize((1 << 22) | 0b10000011);
    dir[2] = PageDirectoryEntry::from_usize((2 << 22) | 0b10000011);
    dir[3] = PageDirectoryEntry::from_usize((3 << 22) | 0b10000011);
